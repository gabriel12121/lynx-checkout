...
<Image src={Mercadopago} alt="logo" width={74} height={29} />
         ...
         <p className="text-muted-foreground">Integração com Whatsapp para disparo automático de mensagens.</p>
       </div>
       <div className="flex flex-col items-start gap-4 rounded-lg border bg-background p-6 shadow-sm transition-all hover:shadow-md">
         <div className="flex items-center gap-4">
<Image src={Shopify} alt="logo" width={74} height={29} />
           <h3 className="text-xl font-semibold">Google Tag Manage</h3>
         </div>
         <p className="text-muted-foreground">Utilize o Gerenciador de tags do Google para criar e atualizar as tags da sua loja virtual.</p>
       </div>
       <div className="flex flex-col items-start gap-4 rounded-lg border bg-background p-6 shadow-sm transition-all hover:shadow-md">
         <div className="flex items-center gap-4">
           <div className=" p-3 text-primary-foreground">
         ...
         <p className="text-muted-foreground">Através do Analytics poderá monitorar o resultado de sua loja.</p>
       </div>
       <div className="flex flex-col items-start gap-4 rounded-lg border bg-background p-6 shadow-sm transition-all hover:shadow-md">
         <div className="flex items-center gap-4">
           <div className=" p-3 text-primary-foreground">
<Image src={Whatsapp} alt="logo" width={74} height={29} />
           ...
           <h3 className="text-xl font-semibold">Kwai</h3>
         </div>
         <p className="text-muted-foreground">Integração nativa com pixel do Kwai para rastreio de suas vendas</p>
       </div>
       <div className="flex flex-col items-start gap-4 rounded-lg border bg-background p-6 shadow-sm transition-all hover:shadow-md">
         <div className="flex items-center gap-4">
           <div className=" p-3 text-primary-foreground">
